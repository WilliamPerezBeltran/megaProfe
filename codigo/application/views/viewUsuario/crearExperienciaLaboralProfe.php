...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    ...
    <section id="projects" class="padding-top">
        ...
        echo form_open_multipart('ControladorUsuario/controladorPrincipal/experienciaLaboralProfe', $attributes);
        ?>
        ...
        <div class="form-group">
            <input name="profesion" type="text" class="form-control" required="required" placeholder="Cargo el cual desempeño" value="<?php echo set_value('profesion'); ?>">
        </div>
        <div class="form-group">
