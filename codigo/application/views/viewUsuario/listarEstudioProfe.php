                   ...
                   <h2><b>Sus estudios son:</b></h2><br>
                    ...
                    <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('ControladorUsuario/controladorPrincipal/editarEstudioProfe/'.$item_infoExperienciaProfe['ID']);?>"><button type="button" class="btn btn-success">Editar</button></a></td>
                                        <td><a href="<?php echo site_url('ControladorUsuario/controladorPrincipal/eliminarEstudioProfe/'.$item_infoExperienciaProfe['ID']);?>"><button type="button" class="btn btn-danger">Eliminar</button></a></td>
                                    </tr>
                                    <?php }?>

                     </table>       
                         
                     <td><a  href="<?php echo site_url('ControladorUsuario/controladorPrincipal/crearEstudioProfe');?>"><button type="button" class="btn  btn-primary">Agregar Estudio</button></a> </td>
                      <a href="<?php echo site_url('ControladorUsuario/controladorPrincipal/listarTemas');?>"><button type="button" class="btn btn-info">Siguiente</button></a>
