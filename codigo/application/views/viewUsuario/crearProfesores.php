...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    ...
    <section id="projects" class="padding-top">
                    ...
                    <div class="sidebar portfolio-sidebar">
                        <div class="sidebar-item categories">
                            ...
                            <ul class="nav navbar-stacked">
                                <li class="active"><a href="#">Información Personal<span class="pull-right">--</span></a></li>
                                <li ><a href="<?php echo site_url('ControladorUsuario/controladorPrincipal/experienciaLaboralProfe')?>">Experiencia laboral<span class="pull-right"></span></a></li>
        ...
        <h2><b>Información Personal</b></h2><br>
