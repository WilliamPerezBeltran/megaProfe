    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center bottom-separator">
                <img src="<?php echo base_url('public/plantillaUsuario/images/home/under.png'); ?>" class="img-responsive inline" alt="">
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="testimonial bottom">
                    ...
                    <div class="media">
                        <div class="pull-left">
                            <a href="#"><img src="<?php echo base_url('public/plantillaUsuario/images/home/profile1.png'); ?>" alt=""></a>
                        </div>
                    ...
                    <div class="media">
                        <div class="pull-left">
                            <a href="#"><img src="<?php echo base_url('public/plantillaUsuario/images/home/profile2.png'); ?>" alt=""></a>
                        </div>
                        <div class="media-body">
...
<script type="text/javascript" src="<?php echo base_url('public/plantillaUsuario/js/lightbox.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('public/plantillaUsuario/js/wow.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('public/plantillaUsuario/js/jquery.isotope.min.js'); ?>"></script>
