...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    ...
    <section id="projects" class="padding-top">
        ...
        <h2><b>Editar estudios</b></h2><br>
        <?php echo validation_errors(); ?> 
        <?php
        $attributes = array('autocomplete' => 'off');
        echo form_open_multipart('ControladorUsuario/controladorPrincipal/editarEstudioProfe/'.$estudioProfesore['ID'], $attributes);
        ?>
        


        <div class="form-group   ">
            <input name="institucion" type="text" class="form-control" required="required" placeholder="Institucion" value="<?php echo set_value('institucion',$estudioProfesore['institucion']); ?>">
        </div>
        <div class="form-group">
            <input name="profesion" type="text" class="form-control" required="required" placeholder="Profesion" value="<?php echo set_value('profesion',$estudioProfesore['profesion']); ?>">
        </div>
        <div class="form-group">
            <input name="ingreso" id="datepickerIngreso" type="text"  class="form-control" required="required" placeholder="Ingreso" value="<?php echo set_value('ingreso',$estudioProfesore['ingreso']); ?>">
        </div>
        <div class="form-group">
            <input name="finalizacion" id="datepickerFinalizacion" type="text"  class="form-control" required="required" placeholder="Finalizacion" value="<?php echo set_value('finalizacion',$estudioProfesore['finalizacion']); ?>">
        </div>
