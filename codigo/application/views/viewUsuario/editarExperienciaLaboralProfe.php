...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    ...
    <section id="projects" class="padding-top">
        ...
        <h2><b>Editar experiencia laboral</b></h2><br>
        <?php echo validation_errors(); ?> 
        <?php
        $attributes = array('autocomplete' => 'off');
        echo form_open_multipart('ControladorUsuario/controladorPrincipal/editarExperienciaLaboralProfesor/'.$editarInfoExperienciaProfe['ID'], $attributes);
        ?>
  
        

        <div class="form-group   ">
            <input name="institucion" type="text" class="form-control" required="required" placeholder="Institucion" value="<?php echo set_value('institucion',$editarInfoExperienciaProfe['institucion']); ?>">
        </div>
        <div class="form-group">
            <input name="profesion" type="text" class="form-control" required="required" placeholder="Profesion" value="<?php echo set_value('profesion',$editarInfoExperienciaProfe['profesion']); ?>">
        </div>
        <div class="form-group">
            <input name="ingreso" id="datepickerIngreso" type="text"  class="form-control" required="required" placeholder="Ingreso" value="<?php echo set_value('ingreso',$editarInfoExperienciaProfe['ingreso']); ?>">
        </div>
        <div class="form-group">
            <input name="finalizacion" id="datepickerFinalizacion" type="text"  class="form-control" required="required" placeholder="Finalizacion" value="<?php echo set_value('finalizacion',$editarInfoExperienciaProfe['finalizacion']); ?>">
        </div>
